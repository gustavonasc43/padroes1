public class Main {
    public static void main(String[] args) {
        ...
        Aviao aviao1 = new Aviao("AV001", 1000000, 500, 30);
        Carro carro1 = new Carro("CAR001", 30000, "Motor 1.0", "ABC1234");
        Helicoptero heli1 = new Helicoptero("HEL001", 500000, 4, 20);
        Moto moto1 = new Moto("MOT001", 20000, "Motor 1.0", "ABC1234","elétrico");
        Onibus onibus1 = new Onibus("ONI001",150000, "Motor 1.0", "ABC1234",  50);
        Onibus onibus2 = new Onibus("ANI002",150000, "Motor 1.0", "ABC1234",  50);
